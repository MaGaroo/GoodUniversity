...
class NewUsersListView(object):
    ...
    def run(self, site, messages=None):
        ...
        user_list = paginator(site.get_unverified_users(site.active_user), 20)
        page_number = 0
        while True:
            pprint_table('New Users', user_list[page_number],
                         foot='Page {} of {}'.format(page_number, len(user_list)))
            menu = ['Home']
            if page_number - 1 >= 0:
